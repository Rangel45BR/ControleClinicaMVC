...
<body>
	...
	<div class="sidebar close">
		<div class="logo-details">
			<i class='bx bxl-c-plus-plus'></i> <span class="logo_name">VeronaTECH</span>
		</div>
		<ul class="nav-links">
			...
			<li>
				<div class="profile-details">
					...
					<div class="name-job">
						<div class="profile_name">${usuario_auth.nome}</div>
						<div class="job">Usuário</div>
					</div>
					<a href="/controle_clinica/logout" onclick="return confirm('Deseja realmente encerrar sua sessão?');"><i class='bx bx-log-out'></i></a>
	...
	<section class="home-section">
		<div class="home-content">
			<i class='bx bx-menu'></i> <span class="text">Sejam Bem Vindos!
				</span>
		</div>
	</section>
	<script>
